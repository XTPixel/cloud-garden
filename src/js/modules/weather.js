(() => {
  const { elements, storageKeys, readStorage, writeStorage } = Garden;

  Garden.loadWeather = function loadWeather(onLoaded) {
  ...
  function renderWeather(weather) {
    ...
    setWeatherState(weather.theme || weatherTheme(weather.code));
  }
